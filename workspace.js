...
cprequire_test(["inline:com-chilipeppr-workspace-oacp"], function(ws) {
    ...
    $('title').html("oacp Workspace");
    $('body').css('padding', '10px');

} /*end_test*/ );

// This is the main definition of your widget. Give it a unique name.
cpdefine("inline:com-chilipeppr-workspace-oacp", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-oacp", // Make the id the same as the cpdefine id
        name: "Workspace / oacp", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace to test how to modify a widget.`,
