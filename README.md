# com-chilipeppr-workspace-oacp
A ChiliPeppr Workspace to test how to modify a widget.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / oacp
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-oacp |
| Name                  | Workspace / oacp |
| Description           | A ChiliPeppr Workspace to test how to modify a widget. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/ghorlando/workspace-oacp/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/orlando1/oa_forking_cp |
| Github URL            | http://github.com/ghorlando/workspace-oacp |
| Test URL              | https://preview.c9users.io/orlando1/oa_forking_cp/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/ghorlando/workspace-oacp/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-oacp"], // the id you gave your workspace
      function(myWorkspaceOacp) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / oacp just got loaded.", myWorkspaceOacp);
        myWorkspaceOacp.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-oacp"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / oacp"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace to test how to modify a widget."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/ghorlando/workspace-oacp/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/orlando1/oa_forking_cp"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/ghorlando/workspace-oacp"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://oa_forking_cp-orlando1.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
